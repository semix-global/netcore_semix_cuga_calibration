...
{
    private const string PermissionControlAttributeFullName = "Net.Utilities.SourceGenerators.Calibration.Attributes.PermissionAttribute";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput(static ctx =>
            ctx.AddSource(
                "SourceGenerators.PermissionAttribute.g.cs",
        ...
        context.RegisterSourceOutput(classDeclarations, static (ctx, classInfo) =>
        {
            ...
            ctx.AddSource(
                $"{classInfo.ClassName}.Permission.g.cs",
                SourceText.From(GeneratePartialClass(classInfo), Encoding.UTF8));
        });
    }
