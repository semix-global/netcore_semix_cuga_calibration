...
{
    public object GetOrDefault(Type type, bool isRecipe, CancellationToken cancellationToken)
    {
    ...
    public object[] GetArrayOrDefault(Type type, bool isRecipe, CancellationToken cancellationToken)
    {
        var cacheEntry = ApplicationCookie.CalibrationViewModelEntries.Values.SingleOrDefault(t => t.CacheType == type);
    ...
    public void Set(Type type, object cache, bool isRecipe, CancellationToken cancellationToken)
    {
        var cacheEntry = ApplicationCookie.CalibrationViewModelEntries.Values.SingleOrDefault(t => t.CacheType == type);
        if (cacheEntry is not null)
        {
    ...
    public void SetArray(Type type, object[] caches, bool isRecipe, CancellationToken cancellationToken)
    {
        var cacheEntry = ApplicationCookie.CalibrationViewModelEntries.Values.SingleOrDefault(t => t.CacheType == type);
