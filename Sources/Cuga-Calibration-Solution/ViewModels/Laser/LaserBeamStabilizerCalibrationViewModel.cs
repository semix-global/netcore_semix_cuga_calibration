...
public sealed partial class LaserBeamStabilizerCalibrationViewModel : CalibrationViewModelBase<LaserBeamStabilizerCache>
{
    #region 属性
    ...
    [RecipeCache]
    [ObservableProperty]
    public override partial LaserBeamStabilizerCache Cache { get; set; } = new();
