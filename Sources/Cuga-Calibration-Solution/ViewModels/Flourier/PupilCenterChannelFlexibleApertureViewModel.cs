        ...
        if (Cache.Ch3Image2 != null)
        {
            ...
            return InvokeCalibrateAsync(() =>
            {
                Logger.LogHtmlInformation("ResultImage", HtmlHeaderLevelEnum.Header3, new HtmlBullet(new
                {
                    ...
                    RodRectHorizal1120_Begin = RodRectHorizal1[0],
                    RodRectHorizal1120_End = RodRectHorizal2[0],
                    RodRectHorizal1120_BeginCenter = RodRectHorizal1[0].Center,
                    RodRectHorizal1120_EndCenter = RodRectHorizal2[0].Center,
