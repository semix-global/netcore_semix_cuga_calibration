...
public sealed partial class AODUniformityViewModel : CalibrationViewModelBase<AODUniformityCache>
{
    #region 属性
    ...
    [RecipeCache]
    [ObservableProperty]
    public override partial AODUniformityCache Cache { get; set; } = new();
