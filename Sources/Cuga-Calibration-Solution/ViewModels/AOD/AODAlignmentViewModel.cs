...
public sealed partial class AODAlignmentViewModel : CalibrationViewModelBase<AODAlignmentCache>
{
    #region 属性
    ...
    [RecipeCache]
    [ObservableProperty]
    public override partial AODAlignmentCache Cache { get; set; } = new();
