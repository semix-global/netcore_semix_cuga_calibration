...
[IOCAppService(ServiceType = typeof(PrescanAODWaveformElectrodeDelayWindowViewModel), IOCLifetimeEnum = IOCLifeTimeEnum.Singleton)]
public sealed class PrescanAODWaveformElectrodeDelayWindowViewModel :
    AbstractAODWaveformElectrodeDelayWindowViewModel<PrescanAODWaveformElectrodeDelayCache, PrescanAODWaveformElectrodeDelayItem, PrescanAODWaveformElectrodeDelayResult>
{
    public override string Name => "Prescan AOD Waveform Electrode Delay V2";

    [DefaultCache]
    public override PrescanAODWaveformElectrodeDelayCache Cache
    {
        get;
        set => SetProperty(ref field, value);
    } = new();

    protected override void GenerateAndSetFlatnessAODWaveform(PrescanAODWaveformElectrodeDelayItem item, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void GenerateResultAODWaveform(PrescanAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void SetResultAODWaveformConfiguration(PrescanAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
