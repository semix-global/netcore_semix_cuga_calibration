...
[IOCAppService(ServiceType = typeof(V0ChirpAODWaveformElectrodeDelayWindowViewModel), IOCLifetimeEnum = IOCLifeTimeEnum.Singleton)]
public sealed class V0ChirpAODWaveformElectrodeDelayWindowViewModel :
    V0AbstractAODWaveformElectrodeDelayWindowViewModel<V0ChirpAODWaveformElectrodeDelayCache, V0ChirpAODWaveformElectrodeDelayItem, V0ChirpAODWaveformElectrodeDelayResult>
{
    public override string Name => "Chirp AOD Waveform Electrode Delay V1";

    [DefaultCache]
    public override V0ChirpAODWaveformElectrodeDelayCache Cache
    {
        get;
        set => SetProperty(ref field, value);
    } = new();

    protected override void GenerateAndSetFlatnessAODWaveform(V0ChirpAODWaveformElectrodeDelayItem item, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void GenerateResultAODWaveform(V0ChirpAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void SetResultAODWaveformConfiguration(V0ChirpAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
