...
[IOCAppService(ServiceType = typeof(V0PrescanAODWaveformElectrodeDelayWindowViewModel), IOCLifetimeEnum = IOCLifeTimeEnum.Singleton)]
public sealed class V0PrescanAODWaveformElectrodeDelayWindowViewModel :
    V0AbstractAODWaveformElectrodeDelayWindowViewModel<V0PrescanAODWaveformElectrodeDelayCache, V0PrescanAODWaveformElectrodeDelayItem, V0PrescanAODWaveformElectrodeDelayResult>
{
    public override string Name => "Prescan AOD Waveform Electrode Delay V1";

    [DefaultCache]
    public override V0PrescanAODWaveformElectrodeDelayCache Cache
    {
        get;
        set => SetProperty(ref field, value);
    } = new();

    protected override void GenerateAndSetFlatnessAODWaveform(V0PrescanAODWaveformElectrodeDelayItem item, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void GenerateResultAODWaveform(V0PrescanAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void SetResultAODWaveformConfiguration(V0PrescanAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
