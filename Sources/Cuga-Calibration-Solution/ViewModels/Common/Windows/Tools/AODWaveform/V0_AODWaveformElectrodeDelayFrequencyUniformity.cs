...
public sealed partial class V0AODWaveformElectrodeDelayFrequencyUniformity<TItem> : ObservableObject
    where TItem : V0AODWaveformElectrodeDelayItem, new()
{
    ...
    [ObservableProperty]
    public partial IReadOnlyList<V0AODWaveformElectrodeDelayFrequencyUniformityItem<TItem>> Items { get; set; } = [];
...
#pragma warning restore IDE0079
    ...
    partial void OnItemsChanged(IReadOnlyList<V0AODWaveformElectrodeDelayFrequencyUniformityItem<TItem>>? oldValue, IReadOnlyList<V0AODWaveformElectrodeDelayFrequencyUniformityItem<TItem>> newValue)
    {
    ...
    public V0AODWaveformElectrodeDelayFrequencyUniformity()
    {
