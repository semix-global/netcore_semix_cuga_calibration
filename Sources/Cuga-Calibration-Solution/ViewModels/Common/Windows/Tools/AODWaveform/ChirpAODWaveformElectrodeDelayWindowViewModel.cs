...
[IOCAppService(ServiceType = typeof(ChirpAODWaveformElectrodeDelayWindowViewModel), IOCLifetimeEnum = IOCLifeTimeEnum.Singleton)]
public sealed class ChirpAODWaveformElectrodeDelayWindowViewModel :
    AbstractAODWaveformElectrodeDelayWindowViewModel<ChirpAODWaveformElectrodeDelayCache, ChirpAODWaveformElectrodeDelayItem, ChirpAODWaveformElectrodeDelayResult>
{
    public override string Name => "Chirp AOD Waveform Electrode Delay V2";

    [DefaultCache]
    public override ChirpAODWaveformElectrodeDelayCache Cache
    {
        get;
        set => SetProperty(ref field, value);
    } = new();

    protected override void GenerateAndSetFlatnessAODWaveform(ChirpAODWaveformElectrodeDelayItem item, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void GenerateResultAODWaveform(ChirpAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
    ...
    protected override void SetResultAODWaveformConfiguration(ChirpAODWaveformElectrodeDelayResult result, Guid htmlLogUniqueId, CancellationToken cancellationToken)
    {
