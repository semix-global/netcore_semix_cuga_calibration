    ...
    AlignmentWindowBrightFieldViewModel alignmentWindowBrightFieldViewModel) : CalibrationViewModelBase
{
    ...
    protected override async Task<bool> LoadedingAsync(CancellationToken cancellationToken)
    {
        ...
        (var isHasCache, Cache) = CacheProvider.TryGetOrDefault<ChuckGlobalScaleErrorCache>();
            ...
            await Task.Run(() =>
            {
                ...
                switch (parameter)
                {
                    case "LowFindPosition":
                        ...
                        Cache.LowTemplateFilePath = $"{TemplateFileDirectory}\\{Cache.LowMicroscopeMagnificationEnum}_{Guid.NewGuid()}";
                    ...
                    case "HighFindPosition":
                        ...
                        Cache.HighTemplateFilePath = $"{TemplateFileDirectory}\\{Cache.HighMicroscopeMagnificationEnum}_{Guid.NewGuid()}";
    ...
    private async Task<bool> Step1CalibrateActionAsync(CancellationToken cancellationToken)
    {
        ...
        await InvokeCalibrateAsync(() =>
        {
            if (ReviewViewModel.TryGetMatchPosition(Cache.AlgorithmTemplateTypeEnum, MicroscopePixelSizeItems, Cache.BaseLowSiteFindPosition, Cache.LowMicroscopeMagnificationEnum, Cache.LowTemplateFilePath, ImageFileDirectory, null, Name,
    ...
    private async Task<bool> Step2CalibrateActionAsync(CancellationToken cancellationToken)
    {
        ...
        await InvokeCalibrateAsync(() =>
        {
            ...
            if (ReviewViewModel.TryGetMatchPosition(Cache.AlgorithmTemplateTypeEnum, MicroscopePixelSizeItems, Cache.BaseHighSiteFindPosition, Cache.HighMicroscopeMagnificationEnum, Cache.HighTemplateFilePath, ImageFileDirectory, null, Name,
    ...
    private (bool isSuccess, ChuckGlobalScaleErrorDto resultDto) GetResult(Dictionary<StageDirectionTypeEnum, Point> idealPositionDictionary, ChuckGlobalScaleErrorDto tempGlobalScaleErrorDto, CancellationToken cancellationToken)
    {
        ...
        bool MatchTemplate(StageDirectionTypeEnum stageDirection, Point ideaPosition, ref ChuckGlobalScaleErrorDto resultDto)
        {
            ...
            if (ReviewViewModel.TryGetMatchPosition(Cache.AlgorithmTemplateTypeEnum, MicroscopePixelSizeItems, highSitePosition, Cache.HighMicroscopeMagnificationEnum, Cache.HighTemplateFilePath, ImageFileDirectory,
                    null, Name,
