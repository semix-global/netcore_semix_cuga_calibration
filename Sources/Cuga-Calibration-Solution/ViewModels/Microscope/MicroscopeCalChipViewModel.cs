...
public sealed partial class MicroscopeCalChipViewModel : CalibrationViewModelBase<MicroscopeCalChipCache>
{
    ...
    public override string CalibrateDirectoryName => EnumHelper.ToDescriptionString(Cache.LowMicroscopeLensInformation.LensName);

    public override string CalibrateFileName => EnumHelper.ToDescriptionString(Cache.LowMicroscopeLensInformation.LensName);
    ...
    protected override async Task<bool> CalibratingAsync(CancellationToken cancellationToken)
    {
        ...
        StageViewModel.SetMachineAbsoluteStageXyByNotAutoFocus(Cache.Item.LeftTopMachinePosition);
        AfViewModel.ToggleCalChipSiteModelEnum(Cache.CalChipSiteModelEnum);
    ...
    protected override async Task<bool> ReviewingAsync(CancellationToken cancellationToken)
    {
        ...
        AfViewModel.ToggleBrightFieldEnable(false);
        await MicroscopeViewModel.SwitchMicroscopeLensInformationNotAutoFocusAsync(Cache.LowMicroscopeLensInformation, isMoveToMicroscopeCenter: false, cancellationToken: cancellationToken).ConfigureAwait(false);
        StageViewModel.SetMachineAbsoluteStageXyByNotAutoFocus(Review.DswItem.BrightFieldMachinePosition);
    ...
    protected override async Task<bool> CancelingAsync()
    {
        ...
        await MicroscopeViewModel.SwitchMicroscopeLensInformationNotAutoFocusAsync(Cache.LowMicroscopeLensInformation, isMoveToMicroscopeCenter: false).ConfigureAwait(false);
    ...
    protected override async Task<bool> PreviousingAsync(CancellationToken cancellationToken)
    {
        switch (CalibrationStepIndex)
        {
            ...
            case 2:
                StageViewModel.SetMachineAbsoluteStageXyByNotAutoFocus(Cache.Item.RightBottomMachinePosition);
                AfViewModel.ToggleCalChipSiteModelEnum(Cache.CalChipSiteModelEnum);

                return true;

            case 3:
                await MicroscopeViewModel.SwitchMicroscopeLensInformationAsync(Cache.LowMicroscopeLensInformation, isMoveToMicroscopeCenter: false, cancellationToken: cancellationToken).ConfigureAwait(false);
                StageViewModel.SetMachineAbsoluteStageXyByNotAutoFocus(Cache.Item.CenterMachinePosition);
                AfViewModel.ToggleCalChipSiteModelEnum(Cache.CalChipSiteModelEnum);
    ...
    private async Task GotoBrightFieldPositionAsync(CalChipSiteModelEnum? calChipSiteModelEnum)
    {
        try
        {
            ...
            await Task.Run(() =>
            {
                ...
                StageViewModel.SetBrightFieldAbsoluteStageXy(StageViewModel.MachineToBrightFieldPosition(Review.CurrentItem.BrightFieldMachinePosition), calChipSiteModelEnum.Value);
    ...
    private void Step0Common(StageDirectionTypeEnum name)
    {
    ...
    private async Task Step1CommonAsync(CancellationToken cancellationToken)
    {
        ...
        StageViewModel.SetAbsoluteStageTheta(0d);
        StageViewModel.SetBrightFieldAbsoluteStageXyByNotAutoFocus(Point.Origin, Cache.CalChipSiteModelEnum);
        await MicroscopeViewModel.SwitchMicroscopeLensInformationAsync(Cache.LowMicroscopeLensInformation, isMoveToMicroscopeCenter: false, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        var ecsValue = (originEndPointIndex1 + originEndPointIndex2) / 2;
        ...
        AfViewModel.SetSensorBrightFieldCalChipStandardEcsValue(Cache.CalChipSiteModelEnum, ecsValue);
        ...
        CalibratingItem.CurrentItem.EcsValue = AfViewModel.GetSensorAverageEcsValue();
    ...
    private Task Step0Async(CancellationToken cancellationToken)
    {
        ...
        {
            Step0Common(StageDirectionTypeEnum.UpLeft);
            return true;
        });
    }
    ...
    private Task Step1Async(CancellationToken cancellationToken)
    {
        return InvokeCalibrateAsync(() =>
        {
            Step0Common(StageDirectionTypeEnum.DownRight);
            return true;
        });
    }
    ...
    [RelayCommand(IncludeCancelCommand = true)]
    private Task Step9Async(CancellationToken cancellationToken)
    {
        return InvokeCalibrateAsync(async () =>
        {
            var (isSuccess, errorMessage) = Cache.Verify();
    ...
    [RelayCommand(IncludeCancelCommand = true)]
    private Task Step10Async(CancellationToken cancellationToken)
    {
        return InvokeCalibrateAsync(() =>
        {
            Step0Common(StageDirectionTypeEnum.UpLeft);
    ...
    [RelayCommand(IncludeCancelCommand = true)]
    private Task Step11Async(CancellationToken cancellationToken)
    {
        return InvokeCalibrateAsync(() =>
        {
            Step0Common(StageDirectionTypeEnum.DownRight);
    ...
    [RelayCommand(IncludeCancelCommand = true)]
    private Task Step12Async(CancellationToken cancellationToken)
    {
        return InvokeCalibrateAsync(async () =>
        {
            var (isSuccess, errorMessage) = Cache.Verify();
        ...
        try
        {
            await InvokeVerifyAsync(async () =>
            {
                ...
                foreach (var calChipSiteModelEnum in EnumHelper.Enums<CalChipSiteModelEnum>().Where(t => t != CalChipSiteModelEnum.ChuckModel))
                {
                    ...
                    StageViewModel.SetMachineAbsoluteStageXyByNotAutoFocus(Cache.Item.CenterMachinePosition);
                    await MicroscopeViewModel.SwitchMicroscopeLensInformationNotAutoFocusAsync(Cache.HighMicroscopeLensInformation, isMoveToMicroscopeCenter: false, cancellationToken: cancellationToken).ConfigureAwait(false);
