...
public sealed partial class CIBLightMatchingViewModel : CalibrationViewModelBase<CIBLightMatchingCache>
{
    #region 属性
    ...
    [RecipeCache]
    [ObservableProperty]
    public override partial CIBLightMatchingCache Cache { get; set; } = new();
        ...
        return InvokeCalibrateAsync(async () =>
        {
            ...
            try
            {
                ...
                async Task SilicaSphereAsync()
                {
                    ...
                    StageViewModel.SetAbsoluteStageTheta(0d);
                    StageViewModel.SetDarkFieldAbsoluteStageXyByNotAutoFocus(silicaSphereBFPosition, CalChipSiteModelEnum.HazeModel);
    ...
    {
        var temps = Guard.IsAssignableToTypeAndReturn<CIBLightMatchingDTO[]>(calibrations);
