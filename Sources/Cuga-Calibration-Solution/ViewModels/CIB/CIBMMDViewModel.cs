...
public sealed partial class CIBMMDViewModel : CalibrationViewModelBase<CIBMMDCache>
{
            ...
            case 2:
                ...
                StageViewModel.SetBrightFieldAbsoluteStageXy(StageViewModel.MachineToBrightFieldPosition(
                    Cache.HazeFindBFMachinePosition == Point.Origin
                        ...
                        : Cache.HazeFindBFMachinePosition), CalChipSiteModelEnum.HazeModel);
    ...
    private void Algorithm(CIBMMDDTO item)
    {
        ...
        try
        {
            ...
            var logGainMul128U12BitFilter = Filter.MovMean([.. logGainMul128U12BitPoints.Select(t => t.Y)], Cache.SmoothLogGainMul128U12BitWindowSize);
            ...
            var gainS16BitFilter = Filter.MovMean([.. gainS16BitPoints.Select(t => t.Y)], Cache.SmoothGainS16BitWindowSize);
