...
public sealed partial class MapView
{
    ...
    private static ILogger<MapView>? _logger;
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        if (DataContext is not ChuckDarkFieldStageMapCalibrationViewModel viewModel) return;
    ...
    {
        if (sender is not ChuckDarkFieldStageMapCalibrationViewModel viewModel) return;
        ...
        {
            case nameof(viewModel.ResultChuckDarkFieldStageMapDto.CalibrationStageMap):
                switch (ChildName)
                {
                    case "Step1View" when viewModel.CalibrationStepIndex == 2:
                    case "Step2View" when viewModel.CalibrationStepIndex is 2 or 3:
                    case "Step3View" when viewModel.CalibrationStepIndex is 2 or 3 or 4:
                        Dispatcher.Invoke(() =>
                        {
                            ShowVectorField(WpfPlot,
                                viewModel.ResultChuckDarkFieldStageMapDto.CalibrationStageMap.IdealStageMapItemMatrix,
                                viewModel.ResultChuckDarkFieldStageMapDto.CalibrationStageMap.ErrorMatrix,
                                viewModel.ResultChuckDarkFieldStageMapDto.CalibrationStageMap.RowNumber,
                                viewModel.ResultChuckDarkFieldStageMapDto.CalibrationStageMap.ColumnNumber,
            ...
            case nameof(viewModel.ResultChuckDarkFieldStageMapDto.ExpandStageMapDto):
                switch (ChildName)
                {
                    case "Step4View" when viewModel.CalibrationStepIndex == 5:
                        Dispatcher.Invoke(() =>
                        {
                            ShowVectorField(WpfPlot,
                                viewModel.ResultChuckDarkFieldStageMapDto.ExpandStageMapDto.IdealStageMapItemMatrix,
                                viewModel.ResultChuckDarkFieldStageMapDto.ExpandStageMapDto.ErrorMatrix,
                                viewModel.ResultChuckDarkFieldStageMapDto.ExpandStageMapDto.RowNumber,
                                viewModel.ResultChuckDarkFieldStageMapDto.ExpandStageMapDto.ColumnNumber,
                                Colors.Red.WithAlpha(0.3),
                                laserLineCentricityItemDto.ForwardDarkMachineCenterPosition,
                                viewModel.Cache.WaferDiameter,
                                labelColor: Colors.Transparent);
                            ShowVectorField(WpfPlot,
                                viewModel.ChuckBrightFieldStageMap.CalibrationStageMap.IdealStageMapItemMatrix,
                                viewModel.ChuckBrightFieldStageMap.CalibrationStageMap.ErrorMatrix,
                                viewModel.ChuckBrightFieldStageMap.CalibrationStageMap.RowNumber,
                                viewModel.ChuckBrightFieldStageMap.CalibrationStageMap.ColumnNumber,
                                Colors.Gray.WithAlpha(0.3),
                                viewModel.ChuckCenter.NewBFCenterStagePosition,
                                viewModel.ChuckBrightFieldStageMapCache.WaferDiameter,
                                false,
                                labelColor: Colors.Transparent);
                        });
                        break;
    ...
    private static void ConfigureWpfPlot(WpfPlot wpfPlot, ChuckDarkFieldStageMapCalibrationViewModel viewModel)
    {
