...
public sealed partial class BrightFieldMapView
{
    private static readonly Turbo ColorMap = new();
    private static ILogger<BrightFieldMapView>? _logger;

    public string ChildName { get; set; } = string.Empty;

    private bool _isLoaded;

    public BrightFieldMapView()
    {
        InitializeComponent();
    ...
    private void ViewModelOnPropertyChanged(object sender, PropertyChangedEventArgs e)
    {
        ...
        {
            case nameof(viewModel.ResultChuckStageMapDto.CalibrationBrightFieldStageMap):
                switch (ChildName)
                {
                    case "Step4View" when viewModel.CalibrationStepIndex == 3:
                    case "Step5View" when viewModel.CalibrationStepIndex is 3 or 4:
                        Dispatcher.Invoke(() =>
                        {
