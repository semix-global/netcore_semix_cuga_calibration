...
public sealed partial class MicroscopeFocusCache : CalibrationCacheBase
{
    ...
    [Comparison(3000d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "FindFocusMin5X: ")]
    ...
    [Comparison(10000d, NumberComparisonTypeEnum.LessThanOrEqual, ErrorMessage = "FindFocusMax5X: ")]
    ...
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "FindFocusMin10X: ")]
    ...
    [Comparison(10000d, NumberComparisonTypeEnum.LessThanOrEqual, ErrorMessage = "FindFocusMax10X: ")]
    ...
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "FindFocusMin50X: ")]
    ...
    [Comparison(10000d, NumberComparisonTypeEnum.LessThanOrEqual, ErrorMessage = "FindFocusMax50X: ")]
    ...
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "FindFocusMin100X: ")]
    ...
    [Comparison(10000d, NumberComparisonTypeEnum.LessThanOrEqual, ErrorMessage = "FindFocusMax100X: ")]
    ...
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "FindFocusMin150X: ")]
    ...
    [Comparison(10000d, NumberComparisonTypeEnum.LessThanOrEqual, ErrorMessage = "FindFocusMax150X: ")]
    ...
    [ComparisonRange(1d, 100d, NumberComparisonRangeTypeEnum.ClosedInterval, ErrorMessage = "FindFocusInterval5X: ")]
    ...
    [ComparisonRange(1d, 100d, NumberComparisonRangeTypeEnum.ClosedInterval, ErrorMessage = "FindFocusInterval10X: ")]
    ...
    [ComparisonRange(1d, 100d, NumberComparisonRangeTypeEnum.ClosedInterval, ErrorMessage = "FindFocusInterval50X: ")]
    ...
    [ComparisonRange(1d, 100d, NumberComparisonRangeTypeEnum.ClosedInterval, ErrorMessage = "FindFocusInterval100X: ")]
    ...
    [ComparisonRange(1d, 100d, NumberComparisonRangeTypeEnum.ClosedInterval, ErrorMessage = "FindFocusInterval150X: ")]
    ...
    [ObservableProperty]
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "SetVoltageAfErrorThreshold5X: ")]
    private double _setVoltageAfErrorThreshold5X;

    [ObservableProperty]
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "SetVoltageAfErrorThreshold10X: ")]
    private double _setVoltageAfErrorThreshold10X;

    [ObservableProperty]
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "SetVoltageAfErrorThreshold50X: ")]
    private double _setVoltageAfErrorThreshold50X;

    [ObservableProperty]
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "SetVoltageAfErrorThreshold100X: ")]
    private double _setVoltageAfErrorThreshold100X;

    [ObservableProperty]
    [Comparison(1d, NumberComparisonTypeEnum.GreaterThanOrEqual, ErrorMessage = "SetVoltageAfErrorThreshold150X: ")]
