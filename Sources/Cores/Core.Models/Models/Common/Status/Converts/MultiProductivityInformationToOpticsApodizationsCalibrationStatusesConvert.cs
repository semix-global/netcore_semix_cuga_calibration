    ...
    : AbstractSingletonMultiConverterBase<MultiProductivityInformationToOpticsApodizationsCalibrationStatusesConvert>
{
    public override object Convert(object?[]? values, Type targetType, object? parameter, CultureInfo culture)
        => values switch
        {
            [IReadOnlyList<ProductivityInformationAndApodizationStatus> calibrationStatuses, ProductivityInformation productivityInformation] =>
                calibrationStatuses.SingleOrDefault(t => t.SelectedItem == productivityInformation)?
