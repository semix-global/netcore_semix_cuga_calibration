...
public sealed class CalibrationCookie(
    Type cacheType,
    Type dtoType,
...
{
    public static readonly CalibrationCookie Default = new(typeof(Empty), typeof(Empty), typeof(Empty), false, new Empty());
    ...
    public CalibrationItemStatus Status { get; } = new();
