...
GenerateAodWaveFile( ...
    ...
    GenerateAodWaveFileConstants.SAMPLE_RATE, ... % 采样率 (Msa/s)
    GenerateAodWaveFileConstants.AMPLITUDE, ... % 幅值
    GenerateAodWaveFileConstants.getOutputDirectory('Chirp\SincCoefficient_SlopeDeltaK'), ... % 生成文件的目录
    GenerateAodWaveFileConstants.ZERO_SAMPLE_COUNT, ... % 前面添加多少补零采样点个数, 相当于添加延迟(sa)
    GenerateAodWaveFileConstants.CHIRP_MODE, ... % 平坦时间 (ns), -1 启用chirp
    GenerateAodWaveFileConstants.SOUND_PACKET_LENGTH, ... % 音包长度 (mm), -1 启用prescan
    GenerateAodWaveFileConstants.ENDPOINT_BUFFER_SAMPLES, ... % 端点头尾添加多少采样点个数, 缓冲(XTC响应不够)(sa)
...
GenerateAodWaveFile( ...
    ...
    GenerateAodWaveFileConstants.SAMPLE_RATE, ... % 采样率 (Msa/s)
    GenerateAodWaveFileConstants.AMPLITUDE, ... % 幅值
    GenerateAodWaveFileConstants.getOutputDirectory('Chirp\Uniformity'), ... % 生成文件的目录
    GenerateAodWaveFileConstants.ZERO_SAMPLE_COUNT, ... % 前面添加多少补零采样点个数, 相当于添加延迟(sa)
    GenerateAodWaveFileConstants.CHIRP_MODE, ... % 平坦时间 (ns), -1 启用chirp
    GenerateAodWaveFileConstants.SOUND_PACKET_LENGTH, ... % 音包长度 (mm), -1 启用prescan
    GenerateAodWaveFileConstants.ENDPOINT_BUFFER_SAMPLES, ... % 端点头尾添加多少采样点个数, 缓冲(XTC响应不够)(sa)
...
%% Chirp Uniformity With SlopeDeltaK
close all;
GenerateAodWaveFile( ...
    GenerateAodWaveFileConstants.BANDWIDTH, ... % 带宽 (MHz)
    GenerateAodWaveFileConstants.CENTER_FREQUENCY, ... % 中心频率 (MHz)
    ...
    GenerateAodWaveFileConstants.SAMPLE_RATE, ... % 采样率 (Msa/s)
    GenerateAodWaveFileConstants.AMPLITUDE, ... % 幅值
    GenerateAodWaveFileConstants.getOutputDirectory('Chirp\Uniformity_SlopeDeltaK'), ... % 生成文件的目录
    GenerateAodWaveFileConstants.ZERO_SAMPLE_COUNT, ... % 前面添加多少补零采样点个数, 相当于添加延迟(sa)
    GenerateAodWaveFileConstants.CHIRP_MODE, ... % 平坦时间 (ns), -1 启用chirp
    GenerateAodWaveFileConstants.SOUND_PACKET_LENGTH, ... % 音包长度 (mm), -1 启用prescan
    GenerateAodWaveFileConstants.ENDPOINT_BUFFER_SAMPLES, ... % 端点头尾添加多少采样点个数, 缓冲(XTC响应不够)(sa)
...
GenerateAodWaveFile( ...
    ...
    GenerateAodWaveFileConstants.SAMPLE_RATE, ... % 采样率 (Msa/s)
    GenerateAodWaveFileConstants.AMPLITUDE, ... % 幅值
    GenerateAodWaveFileConstants.getOutputDirectory('Prescan\SincCoefficient_SlopeDeltaK'), ... % 生成文件的目录
    GenerateAodWaveFileConstants.ZERO_SAMPLE_COUNT, ... % 前面添加多少补零采样点个数, 相当于添加延迟(sa)
    GenerateAodWaveFileConstants.FLATNESS_TIME, ... % 平坦时间 (ns), -1 启用chirp
    GenerateAodWaveFileConstants.PRESCAN_MODE, ... % 音包长度 (mm), -1 启用prescan
    GenerateAodWaveFileConstants.ENDPOINT_BUFFER_SAMPLES, ... % 端点头尾添加多少采样点个数, 缓冲(XTC响应不够)(sa)
...
GenerateAodWaveFile( ...
    ...
    GenerateAodWaveFileConstants.SAMPLE_RATE, ... % 采样率 (Msa/s)
    GenerateAodWaveFileConstants.AMPLITUDE, ... % 幅值
    GenerateAodWaveFileConstants.getOutputDirectory('Prescan\Uniformity'), ... % 生成文件的目录
    GenerateAodWaveFileConstants.ZERO_SAMPLE_COUNT, ... % 前面添加多少补零采样点个数, 相当于添加延迟(sa)
    GenerateAodWaveFileConstants.FLATNESS_TIME, ... % 平坦时间 (ns), -1 启用chirp
    GenerateAodWaveFileConstants.PRESCAN_MODE, ... % 音包长度 (mm), -1 启用prescan
    GenerateAodWaveFileConstants.ENDPOINT_BUFFER_SAMPLES, ... % 端点头尾添加多少采样点个数, 缓冲(XTC响应不够)(sa)
...
%% Prescan Uniformity With SlopeDeltaK
close all;
GenerateAodWaveFile( ...
    GenerateAodWaveFileConstants.BANDWIDTH, ... % 带宽 (MHz)
    GenerateAodWaveFileConstants.CENTER_FREQUENCY, ... % 中心频率 (MHz)
    ...
    GenerateAodWaveFileConstants.SAMPLE_RATE, ... % 采样率 (Msa/s)
    GenerateAodWaveFileConstants.AMPLITUDE, ... % 幅值
    GenerateAodWaveFileConstants.getOutputDirectory('Prescan\Uniformity_SlopeDeltaK'), ... % 生成文件的目录
    GenerateAodWaveFileConstants.ZERO_SAMPLE_COUNT, ... % 前面添加多少补零采样点个数, 相当于添加延迟(sa)
    GenerateAodWaveFileConstants.FLATNESS_TIME, ... % 平坦时间 (ns), -1 启用chirp
    GenerateAodWaveFileConstants.PRESCAN_MODE, ... % 音包长度 (mm), -1 启用prescan
    GenerateAodWaveFileConstants.ENDPOINT_BUFFER_SAMPLES, ... % 端点头尾添加多少采样点个数, 缓冲(XTC响应不够)(sa)
