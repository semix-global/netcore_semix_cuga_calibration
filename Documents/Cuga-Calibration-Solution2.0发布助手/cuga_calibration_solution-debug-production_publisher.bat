...
echo **************************************************************************************************************
echo *                                                                                                            *
echo *                              Welcome to Cuga-Calibration-Solution-Debug-Production Publish Assistant       *
echo *                                                                                                            *
echo *                                          version V2.0                                                      *
echo *                                                                                                            *
echo **************************************************************************************************************
...
set apps_home=C:\APPs\Cuga-Calibration-Debug
set repository_path=%apps_home%\Cuga-Calibration-Solution_Code
set apps_name=Cuga-Calibration-Solution-Debug-Production_Publish
...
if /I %compile_mode%=="Debug" (
	...
	%tempDir%\dotnet-sdk-8.0.303-win-x64\dotnet.exe publish %repository_path%\%csproj_name% --configuration Debug --framework net480 --runtime win-x64 --no-self-contained --output %repository_path%\%csproj_output_name%
) else (
	echo.
	echo.
	echo it will take a while to compile, take a coffee break ...
	%tempDir%\dotnet-sdk-8.0.303-win-x64\dotnet.exe publish %repository_path%\%csproj_name% --configuration Release --framework net480 --runtime win-x64 --no-self-contained --output %repository_path%\%csproj_output_name%
)
