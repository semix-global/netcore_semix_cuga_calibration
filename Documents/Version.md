...
> 2. 优化
>    
>    #156 解决一些紧急bug(MMD无法进入, 不需要判断OD电机是否启用. StringToBitmapSourceConverter格式不支持不能抛异常, 导致解析XAML报错后续binding失效问题)
...
>    #133 BestFocus 散光校准
>    #154 傅里叶5个校准
>    #156 AGC Delay2.0测试优化、波形自动导入优化
>    #157 涉及到默认波形的校准初始化时自动加载参数
>    #167 采集偏振校准提高速度
> 
> 2. 架构
>    
>    #153 Recipe review重构
>    #160 HImage替换为BitmapImage
>    #161 自定义保存校准结果
>    #163 缓存添加版本控制, 以及减少存储空间
>    #165 主项目移除算法库引用
>    
>    #166 添加校准离线在线判断，cuga退出后 校准无法使用，必须关闭重开，并添加缓存刷新功能
> 
> 3. bug修复
>    
...
> 1. Bug修复
>    
>    #180 dll替换，修复linecentricity verify没有正确应用pmtInterval的bug