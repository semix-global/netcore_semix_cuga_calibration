function aodWaveFilePath = GenerateAodWaveFile( ...
    ...
    if soundPacketLength == -1
        aodWaveFilePath = fullfile(aodWaveDirectory, ...
            sprintf('prescan_%0.3fBWMhz_%s_%0.3fns_%0.3fAMP_%0.3fastigmatism_%0.3fsphericalAberration_%0.3fsecondaryAstigmatism_%0.3fcomaCompensationCoefficient_%dCount_$%d$%d$600$02$%0.3f$%0.3f$.txt', ...
            readonlyBandWidth, ...
            frequencyFileName, ...
            flatnessTime, ...
            amplitude, ...
        ...
        aodWaveFilePath = fullfile(aodWaveDirectory, ...
            sprintf('chirp_%0.3fmm_%0.3fBWMhz_%s_%0.3fns_%0.3fAMP_%0.3fastigmatism_%0.3fsphericalAberration_%0.3fsecondaryAstigmatism_%0.3fcomaCompensationCoefficient%dCount_$%d$%d$600$03$%0.3f$%0.3f$.txt', ...
            soundPacketLength, ...
            readonlyBandWidth, ...
            frequencyFileName, ...
            flatnessTime, ...
    ...
    while isOk == 0
        ...
        if isOk == 1
            ...
            if exist(frequencyAmplitudeFilePath, 'file')
                ...
                [sortedFrequencies, sortIdx] = sort(freqAmpData.CenterFrequency);
            ...
            fftMagnitudesNew = abs(fftResultResult(1:length(flatnessAodWaveSignals) / 2 + 1));
