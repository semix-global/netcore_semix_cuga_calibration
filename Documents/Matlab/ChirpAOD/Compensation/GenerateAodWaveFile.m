function aodWaveFilePath = GenerateAodWaveFile( ...
    ...
    if soundPacketLength == -1
        ...
        aodWaveFilePath = fullfile(aodWaveDirectory, ...
            sprintf('chirp_%0.3fmm_%0.3fBWMhz_%s_%0.3fns_%0.3fAMP_%0.3fastigmatism_%0.3fsphericalAberration_%0.3fsecondaryAstigmatism_%0.3fcomaCompensationCoefficient_%dCount_$%d$%d$600$03$%0.3f$%0.3f$.txt', ...
            soundPacketLength, ...
            readonlyBandWidth, ...
            frequencyFileName, ...
            flatnessTime, ...
...
function PlotAodWaveAnalysis( ...
    ...
    % 2. 合成频率
    subplot(3, 3, 2);
    plot(flatnessSampleIndices, dFlatnessFrequencies, 'r', 'LineWidth', 2);
    xlabel('Number of Samples');
    ylabel('Frequency (MHz)');
