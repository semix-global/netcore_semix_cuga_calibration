...
for i=1:lengthx
 ...
 % b1_array(i)=b1;
  ...
  theta1(i)=atan(((k2-k1)/(1+k1*k2)))*180/pi;  %%%每列的夹角
end
...
%fid = fopen('C:\Users\Administrator\Desktop\rawdata\x.txt','w');
%fprintf(fid,[repmat('%5.9f\t', 1, size(a,2)), '\n'], a');     
%fclose(fid);
b=corrected_error_y;
%fid = fopen('C:\Users\Administrator\Desktop\rawdata\y.txt','w');
%fprintf(fid,[repmat('%5.9f\t', 1, size(b,2)), '\n'], b');     
%fclose(fid);
xlswrite('C:\Users\DELL\Desktop\rawdata\x.csv',a);
xlswrite('C:\Users\DELL\Desktop\rawdata\y.csv',b);