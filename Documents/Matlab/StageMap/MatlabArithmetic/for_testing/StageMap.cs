...
namespace MatlabArithmetic
{

  /// <summary>
  /// The StageMap class provides a CLS compliant, MWArray interface to the MATLAB
  ...
  public class StageMap : IDisposable
  {
    ...
    ///
    public MWArray CalculateChuckStageMapError()
    {
      return mcr.EvaluateFunction("CalculateChuckStageMapError", new MWArray[]{});
    }
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray CalculateChuckStageMapError(MWArray xx1)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray CalculateChuckStageMapError(MWArray xx1, MWArray yy1)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray CalculateChuckStageMapError(MWArray xx1, MWArray yy1, MWArray xx2)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CalculateChuckStageMapError(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "CalculateChuckStageMapError", new MWArray[]{});
    }
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CalculateChuckStageMapError(int numArgsOut, MWArray xx1)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CalculateChuckStageMapError(int numArgsOut, MWArray xx1, MWArray yy1)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CalculateChuckStageMapError(int numArgsOut, MWArray xx1, MWArray 
                                           yy1, MWArray xx2)
    {
    ...
    ///
    public void CalculateChuckStageMapError(int numArgsOut, ref MWArray[] argsOut, 
                                  MWArray[] argsIn)
    {
      mcr.EvaluateFunction("CalculateChuckStageMapError", numArgsOut, ref argsOut, 
                                  argsIn);
    }


    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the CreateFit MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray CreateFit()
    {
      return mcr.EvaluateFunction("CreateFit", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the CreateFit MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray CreateFit(MWArray xx1)
    {
    ...
    /// <summary>
    /// Provides a single output, 2-input MWArrayinterface to the CreateFit MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray CreateFit(MWArray xx1, MWArray yy1)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the CreateFit MATLAB function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CreateFit(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "CreateFit", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the CreateFit MATLAB function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CreateFit(int numArgsOut, MWArray xx1)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input MWArray interface to the CreateFit MATLAB function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] CreateFit(int numArgsOut, MWArray xx1, MWArray yy1)
    {
    ...
    /// <param name= "argsIn">Array of MWArray input arguments</param>
    ///
    public void CreateFit(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("CreateFit", numArgsOut, ref argsOut, argsIn);
    }
